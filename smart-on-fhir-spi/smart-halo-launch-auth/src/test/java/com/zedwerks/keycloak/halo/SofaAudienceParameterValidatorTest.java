 ...
 * 
 */
package com.zedwerks.keycloak.halo;
...
import com.zedwerks.keycloak.halo.authenticators.SofaAudienceValidator;
import com.zedwerks.keycloak.halo.authenticators.SofaAudienceValidatorFactory;

import java.net.URI;
import java.util.Map;
import java.util.HashMap;

public class SofaAudienceParameterValidatorTest {
    ...
    public void testAudienceValidation() {
        ...
        Authenticator authenticator = new SofaAudienceValidator(session);

        SofaAudienceValidatorFactory factory = mock(SofaAudienceValidatorFactory.class);

        MultivaluedMap<String, String> queryParameters = new MultivaluedHashMap<String,String>();
        queryParameters.putSingle("aud", "https://fhir.example.com/fhir");
        queryParameters.putSingle("launch", "E0727D19-7568-499D-ADA6-49872786745E");

        when(realm.getAttribute("smart_halo_sofa_audience")).thenReturn("https://fhir.example.com/fhir");
        ...
        when(context.getHttpRequest().getUri()).thenReturn(uriInfo);
