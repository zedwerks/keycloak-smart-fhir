...
public class ExternalHaloLaunchResolverFactory implements AuthenticatorFactory {
    ...
    private static ExternalHaloLaunchResolver _haloLaunchContextResolver;
        // NO
    @Override
    ...
    public Authenticator create(KeycloakSession session) {
        ...
        _haloLaunchContextResolver = new ExternalHaloLaunchResolver(session);

        return _haloLaunchContextResolver;
    }
