...
import com.zedwerks.keycloak.smart.endpoints.SmartContextResource;
...
public class SmartContextResourceProvider implements RealmResourceProvider {
    ...
    public SmartContextResourceProvider(KeycloakSession session, ContextCacheService contextService) {
