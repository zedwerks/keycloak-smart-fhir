...
output "halo_smart_browser_flow_id" {
  value = keycloak_authentication_flow.halo_smart_browser_flow.id
  description = "The ID of the browser flow for HALO SMART on FHIR"
